  ...
  const templates = [
    {
      id: "basic-educator",
      name: "Basic Educator",
      description: "Default template for new educators - limited permissions until they prove themselves",
      permissions: {
    ...
    {
      id: "standard-educator",
      name: "Standard Educator",
      description: "Standard permissions for verified educators",
      permissions: {
        canPublishQuiz: true,
        canAddStudents: true,
        canEditQuiz: true,
