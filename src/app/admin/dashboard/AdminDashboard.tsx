...
import { 
  ...
  UserCheck, UserX, Eye, Settings, BarChart
} from "lucide-react";
...
export default function AdminDashboard({ stats, pendingEducators, allEducators, allStudents, adminEmail }: AdminDashboardProps) {
